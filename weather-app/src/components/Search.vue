...
import overcast from "./../assets/overcast_cloud.jpeg";
  ...
  >
    ...
    <div class="flex justify-center flex-wrap">
      ...
      >
        <div
          v-if="item"
          class="max-w-sm md:max-w-full my-10 bg-white border m-3 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
          style="box-shadow: #7f7f7f 0px 1px 18px 1px"
        >
          <a href="#">
            <img
              class="rounded-t-lg object-cover w-full"
              :src="getImageSource(item.weather)"
              alt=""
            />
          </a>
          <div class="p-5 text-center">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
              <h1 class="m-2 md:mx-3">
                <span class="font-semibold">Min </span>{{ item.mintemp }} &deg;C
              </h1>
              <h1 class="m-2 md:mx-3 font-semibold text-3xl">
                {{ item.temperature }} &deg;C
              </h1>
              <h1 class="m-2 md:mx-3">
                <span class="font-semibold">Max </span>{{ item.maxtemp }} &deg;C
              </h1>
            </div>
            <h1 class="m-2 md:mx-3">
